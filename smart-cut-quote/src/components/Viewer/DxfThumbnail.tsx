/**
 * DXF Thumbnail Component
 * Simple, lightweight component for rendering DXF thumbnails in DataGrid cells
 * Optimized for small size (80x80) with proper aspect ratio
 */
...
export default function DxfThumbnail({ filePath, size = 80 }: DxfThumbnailProps) {
  ...
  useEffect(() => {
    ...
    const loadAndRender = async () => {
      try {
        ...
        console.error('DxfThumbnail error:', err);
        if (isMounted) {
          setError(true);
        }
      }
